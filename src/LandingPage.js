          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-4 w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <div className="flex flex-col items-center md:items-center md:flex-grow">
                <a href="https://www.healthserviceshub.com/account/promo" className="inline-block bg-blue-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all text-center md:self-end">
                  Sign Up For Free
                </a>
                <p className="text-sm mt-2 text-gray-600 md:text-right">Use Code RIT on the following page</p>
              </div>
            </div>
          </div>
        </div>
